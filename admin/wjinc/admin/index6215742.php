...
<body>
	...
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title"><a class="tjgk bq load" href="system/settings">系统设置</a><a class="tjgk bq load" href="business/betLog">普通投注</a><a class="tjgk bq load" href="member/index">用户列表</a><a class="tjgk bq load" onClick="rechargModal()" style="cursor:pointer" value="充值">账号充值</a><a class="tjgk bq load" method="post" target="ajax" call="clearDataSuccess" title="即将清空程序缓存，是否继续！" dataType="json" href="/admin778899.php/clear/rmfile">清空缓存</a>
            </h2>
