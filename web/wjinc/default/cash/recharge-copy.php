...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
    ...
    <td colspan="2" align="right" class="copyss">
	 <form action="/mpay/pay.php" method="post" name="a" target="_blank" > 
...
<table width="100%" border="0" cellspacing="1" cellpadding="3" class='table_b'>
    ...
    <input type="hidden" name="title" value="<?=$args[0]['rechargeId']?>">
    <input type="hidden" name="memo" value="<?=$this->user['username']?>">
